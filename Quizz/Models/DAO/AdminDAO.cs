...
namespace Quizz.Models.DAO
{
    public class AdminDAO
    {
        ...
        /// 
        /// </summary>
        public IPagedList<SubjectViewModel> PageSubject1(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
        ...
        public IPagedList<SubjectViewModel> PageSubject2(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
        ...
        public IPagedList<SubjectViewModel> PageSubject23(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
        ...
        public IPagedList<SubjectViewModel> PageSubject4(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
        ...
        public IPagedList<SubjectViewModel> PageSubject5(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
        ...
        public IPagedList<SubjectViewModel> PageSubject6(int? page, string search)
        {
            int pageSize = 10;
            int pageIndex = 1;
            pageIndex = page.HasValue ? Convert.ToInt32(page) : 1;
