...
--> Question Practice
--> MAE
INSERT INTO Questions VALUES (N'Transportation officials tell us that 70% of drivers wear seat belts while driving. Find the probability that more than 579 drivers in a sample of 800 drivers wear seat belts. Let P(Z < 1.5) = 0.0668; P(Z<0.25) = 0.6',N'0.0668', N'0.9332',N'0.4',N'0.6','B',0,2)
INSERT INTO Questions VALUES (N'Suppose X is a uniform random variable over the interval [40, 50). Find the probability that a randomly selected observation exceeds 43.',N'0.3', N'0.1',N'0.7',N'0.9','C',0,2)
INSERT INTO Questions VALUES (N'A card is drawn from a standard deck of 52 playing cards. Find the probability that the card is an ace or a king.',N'1/13', N'3/13',N'4/13',N'2/13','D',0,2)
INSERT INTO Questions VALUES (N'A pair of dice is thrown twice. What is the probability of getting totals of 7 and 11?',N'1/54', N'1/24',N'1/18',N'1/14','A',0,2)
--> DTG302
INSERT INTO Questions VALUES (N'This is any paid form of non-personal presentation and promotion of ideas, goods and services by an identified sponsor',N'Advertising', N'Marketing',N'Communication',N'Media','A',0,6)
INSERT INTO Questions VALUES (N'Focused on establishing a corporate identity or winning the public over to the organization''s point of view',N'Institutional Advertising', N'Nonprofit Advertising',N'Public Service Advertising',N'Brand Advertising','A',0,6)
INSERT INTO Questions VALUES (N'What are the effects behind effectiveness?',N'Attention', N'Interest',N'Desire',N'All others are correct','D',0,6)
INSERT INTO Questions VALUES (N'Which is not role of advertising?',N'Communication role', N'Economic role',N'Managerial role',N'Marketing role','C',0,6)
--> MAD
INSERT INTO Questions VALUES (N'Let P(Z < 1.5) = 0.0668; P(Z<0.25) = 0.6',N'0.0668', N'0.9332',N'0.4',N'0.6','B',0,1)
